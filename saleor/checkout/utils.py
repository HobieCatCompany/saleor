...
def create_order(*, checkout: Checkout, order_data: dict, user: User) -> Order:
    ...
    #send_order_confirmation.delay(order.pk, user.pk) #HOBIE commented out.  Moved this call into hobie.views.start_payment because of some transaction handling issues.
    return order
